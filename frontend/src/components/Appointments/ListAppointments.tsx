...
const ListAppointments = ({ appointments, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>AppointmentDate</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.dateTimeFormatter(item.appointment_date) }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.doctorsOneListFormatter(item.doctor) }</p>
                            </div>
