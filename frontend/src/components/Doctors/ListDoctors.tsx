...
const ListDoctors = ({ doctors, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ item.specialization }</p>
                            </div>
