...
const PrescriptionsView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View prescriptions')} main>
                <BaseButton
                  color='info'
                  label='Edit'
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Appointment</p>
                        ...
                        <p>{prescriptions?.appointment?.appointment_date ?? 'No data'}</p>

                </div>

                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>TrackingCode</p>
                    <p>{prescriptions?.tracking_code}</p>
                </div>
