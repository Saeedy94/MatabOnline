...
import { create } from '../../stores/medical_records/medical_recordsSlice'
...
Medical_recordsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Medical_recordsNew
